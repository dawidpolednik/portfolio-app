export const plMessages = {
  translations: {
    ...
    aboutMeSection: {
      ...
      firstParagraph:
        "Nazywam się Dawid Polednik, jestem Front-End Developerem pochodzącym z małego miasteczka spod Raciborza. Zajmuję się tworzeniem stron internetowych.",
      secondParagraph:
        "Mam ponad trzyletnie praktyczne doświadczenie w programowaniu aplikacji internetowych przy użyciu HTML5, CSS3 oraz języka JavaScript (TypeScript) z wykorzystaniem biblioteki React.",
      thirdParagraph:
      ...
      fifthParagraph:
        "Obecnie pracuję na stanowisku Front-End Developera w firmie Angry Nerds - Software Development Company.",
      sixthParagraph:
    ...
    educationSection: {
      ...
      lifeEvents: {
        currentWork: {
          time: "01.2023 - obecnie",
          header: "Angry Nerds - Software Development Company",
          description:
            "Praca w projektach opartych o technologie takie jak: React, Next, Preact, TypeScript, Storybook, styled-components, Vite.",
        },
        secondWork: {
          time: "08.2021 - 12.2022",
          header: "j-labs software specialists",
          description:
            "Praca w projektach opartych o technologie takie jak: React, Redux, TypeScript, Jest, Enzyme, Storybook, styled-components.",
        },
        firstWork: {
